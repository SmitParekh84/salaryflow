...
Use **shadcn/ui** as the source-owned component system and keep Aartha's existing color,
...
Status: this remains an incremental backlog, not a prerequisite for the shipped product. Aartha
...
rate-limit cooldowns, and bounded inputs. Aartha should reuse those patterns, but use the
